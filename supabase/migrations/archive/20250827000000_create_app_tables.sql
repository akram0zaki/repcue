...
CREATE INDEX idx_user_preferences_owner ON user_preferences(owner_id);
CREATE INDEX idx_app_settings_owner ON app_settings(owner_id);
CREATE INDEX idx_exercises_owner ON exercises(owner_id);
CREATE INDEX idx_exercises_updated ON exercises(owner_id, updated_at DESC);
CREATE INDEX idx_workouts_owner ON workouts(owner_id);
CREATE INDEX idx_workouts_updated ON workouts(owner_id, updated_at DESC);
CREATE INDEX idx_activity_logs_owner ON activity_logs(owner_id);
CREATE INDEX idx_activity_logs_date ON activity_logs(owner_id, activity_date DESC);
CREATE INDEX idx_workout_sessions_owner ON workout_sessions(owner_id);
CREATE INDEX idx_workout_sessions_workout ON workout_sessions(workout_id);
CREATE INDEX idx_workout_sessions_updated ON workout_sessions(owner_id, updated_at DESC);
...
CREATE INDEX idx_sync_cursors_updated ON sync_cursors(updated_at DESC);