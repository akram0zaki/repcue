...
import type { UserProfile, Connection, UserStats } from '../types';
import { profileService } from '../services/profileService';
import { MoreHorizontalIcon, EditIcon, UsersIcon, SettingsIcon } from '../components/icons/NavigationIcons';

interface ProfilePageProps {
  isOwnProfile?: boolean;
}

const ProfilePage: React.FC<ProfilePageProps> = ({ isOwnProfile = true }) => {
