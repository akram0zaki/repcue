...
export const ExercisesIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const LogIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SettingsIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m11-7h-6m-6 0H1m21-6h-6M7 7h6m6 0h6M7 17h6m6 0h6" />
  </svg>
);

export const ScheduleIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Page-specific icons that follow the same consistent style
...
export const FlexibilityIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const BalanceIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const HandWarmupIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M14 10V9a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v2" />
    <path d="M10 10.5V9a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8.5a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 .5-.5v-5a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v.5" />
  </svg>
);

export const RunnerIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M6 12h3l3-4 3 2" />
    <path d="M16 14l-2 4h-2l-1-3" />
    <path d="M8 16l-2 4" />
    <path d="M13 10l2-2h3" />
  </svg>
);
...
export const WorkoutIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ReadyIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CollapseIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const DuplicateIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const MoveUpIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const MoveDownIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CoachIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
