        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-2">
            ...
            >
              ...
              <span className="truncate">{t('profile.viewProfile', 'View Profile')}</span>
            </button>
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-2 py-2.5 px-3 bg-gray-600 hover:bg-gray-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 text-sm min-w-0 w-full"
            >
              <svg className="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
              </svg>
              <span className="truncate">{loading ? t('common:loading') : t('signOut')}</span>
            </button>
          </div>
        </div>
      ) : (
