...
export const ExerciseSelector: React.FC<ExerciseSelectorProps> = ({
  ...
  return (
    <div className={`exercise-selector flex flex-col h-full ${className}`}>
      {/* Catalog Selector */}
      {showCatalogSelector && (
        ...
        <div className="flex-shrink-0 mb-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-10 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
            />
